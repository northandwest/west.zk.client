...
public class WestZookeeperClient {

	private final int CONNECT_TIMEOUT = 15000;
	private final int RETRY_TIME = Integer.MAX_VALUE;
	private final int RETRY_INTERVAL = 1000;
	private static final Logger logger = LoggerFactory.getLogger(WestZookeeperClient.class);
	private CuratorFramework curator;

	private volatile static WestZookeeperClient instance;
	...
	public WestZookeeperClient(String zkServers) {
		if (curator == null) {
	...
	public static WestZookeeperClient getInstance(String zkServers) {
		if (instance == null) {
			synchronized (WestZookeeperClient.class) {
				if (instance == null) {
					logger.info("initial CuratorZookeeperClient instance");
					instance = new WestZookeeperClient(zkServers);
				}
			}
		}
		return instance;
